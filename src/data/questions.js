...
export const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q5b', label: '알록달록 산호초가 있는 평화로운 바다', img: `${BASE}images/q5_b.jpg`, score: { S: 1 } },
    ],
  },
  {
    id: 'q6',
    ...
    options: [
      { id: 'q6a', label: '광활한 바다를 배경으로 한 내 뒷모습', img: `${BASE}images/q6_a.jpg`, score: { B: 1 } },
      { id: 'q6b', label: '산호 틈에 숨은 귀여운 니모의 초근접샷', img: `${BASE}images/q6_b.jpg`, score: { D: 1 } },
    ],
  },
  {
    id: 'q7',
    ...
    options: [
      { id: 'q7a', label: '피곤하니 일단 쉬고 여운을 즐기다 나중에 생각날 때 쓴다', img: `${BASE}images/q7_a.jpg`, score: { E: 1 } },
